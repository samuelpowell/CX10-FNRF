...
//  SPI MISO pin configuration
  ...
  GPIO_PinAFConfig(GPIOB, RADIO_GPIO_SPI_SCK, GPIO_AF_0);
  GPIO_PinAFConfig(GPIOB, RADIO_GPIO_SPI_MOSI, GPIO_AF_0);
  GPIO_PinAFConfig(GPIOB, RADIO_GPIO_SPI_MISO, GPIO_AF_0);
